...
/**
 * call_args - partitions operations from commands and call them
...
/**
 * handle_args - calls and runs execution of commands
 * @exe_ret: return value of the parent process
 ...
 * Return: if a ';' '&&' is placed at an invalid position 2
 * otherwise 0
 */
